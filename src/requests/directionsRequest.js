...
const directions = (googleId) => {
  Promise.all([
    ...
    const dataDrivingDirection = {
      distance_text:
        values[0].routes[0].legs[0].distance.text != undefined
          ? values[0].routes[0].legs[0].distance.text
          : 0,
      distance_km:
        values[0].routes[0].legs[0].distance.value != undefined
          ? values[0].routes[0].legs[0].distance.value / 1000
          : 0,
      duration_text:
        values[0].routes[0].legs[0].duration_in_traffic.text != undefined
          ? values[0].routes[0].legs[0].duration_in_traffic.text
          : 0,
      duration_value:
        values[0].routes[0].legs[0].duration_in_traffic.value != undefined
          ? values[0].routes[0].legs[0].duration_in_traffic.value / 60
          : 0,
      start_adress:
        values[0].routes[0].legs[0].start_address != undefined
          ? values[0].routes[0].legs[0].start_address
          : 0,
      end_adress:
        values[0].routes[0].legs[0].end_address != undefined
    ...
    const dataWalkingDirection = {
      distance_text:
        values[1].routes[0].legs[0].distance.text != undefined
          ? values[1].routes[0].legs[0].distance.text
          : 0,
      distance_km:
        values[1].routes[0].legs[0].distance.value != undefined
          ? values[1].routes[0].legs[0].distance.value / 1000
          : 0,
      duration_text:
        values[1].routes[0].legs[0].duration.text != undefined
          ? values[1].routes[0].legs[0].duration.text
          : 0,
      duration_value:
        values[1].routes[0].legs[0].duration.value != undefined
          ? values[1].routes[0].legs[0].duration.value / 60
          : 0,
      start_adress:
        values[1].routes[0].legs[0].start_address != undefined
          ? values[1].routes[0].legs[0].start_address
          : 0,
      end_adress:
        values[1].routes[0].legs[0].end_address != undefined
    ...
    const dataBicyclingDirection = {
      distance_text:
        values[2].routes[0].legs[0].distance.text != undefined
          ? values[2].routes[0].legs[0].distance.text
          : 0,
      distance_km:
        values[2].routes[0].legs[0].distance.value != undefined
          ? values[2].routes[0].legs[0].distance.value / 1000
          : 0,
      duration_text:
        values[2].routes[0].legs[0].duration.text != undefined
          ? values[2].routes[0].legs[0].duration.text
          : 0,
      duration_value:
        values[2].routes[0].legs[0].duration.value != undefined
          ? values[2].routes[0].legs[0].duration.value / 60
          : 0,
      start_adress:
        values[2].routes[0].legs[0].start_address != undefined
          ? values[2].routes[0].legs[0].start_address
          : 0,
      end_adress:
        values[2].routes[0].legs[0].end_address != undefined
